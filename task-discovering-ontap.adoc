...
從 Canvas 手動提供叢集的詳細資料、或從「我的資產」頁面選取預先探索的叢集、即可從 Canvas 探索內部部署的 ONTAP 叢集。

.關於這項工作
* 您可以使用下列兩種方式之一來啟動探索程序：
+
...
** 如果您使用雲端帳戶登入 BlueXP 並瀏覽至「我的資產」頁面、 BlueXP 會提示您驗證電子郵件。如果該電子郵件地址與 NSS 帳戶相關聯、 BlueXP 會使用該資訊來尋找與該帳戶相關聯的叢集。
